...
module SimpleCov
  ...
  class << self
    ...
    #
    # pkg:gem/simplecov#lib/simplecov.rb:62
    ...
    #
    # pkg:gem/simplecov#lib/simplecov.rb:57
    ...
    #
    # pkg:gem/simplecov#lib/simplecov.rb:47
    ...
    #
    # pkg:gem/simplecov#lib/simplecov.rb:122
    ...
    #
    # pkg:gem/simplecov#lib/simplecov.rb:52
    ...
    #
    # pkg:gem/simplecov#lib/simplecov.rb:37
    ...
    # pkg:gem/simplecov#lib/simplecov.rb:19
    def pid; end
    ...
    #
    # pkg:gem/simplecov#lib/simplecov.rb:141
    ...
    #
    # pkg:gem/simplecov#lib/simplecov.rb:31
    ...
    # pkg:gem/simplecov#lib/simplecov.rb:103
    ...
    # pkg:gem/simplecov#lib/simplecov.rb:193
    ...
    #
    # pkg:gem/simplecov#lib/simplecov.rb:169
...
module SimpleCov::Color
  ...
  # pkg:gem/simplecov#lib/simplecov/color.rb:69
  def env_set?(name); end

  # pkg:gem/simplecov#lib/simplecov/color.rb:45
...
module SimpleCov::Combine::BranchesCombiner
  ...
  # pkg:gem/simplecov#lib/simplecov/combine/branches_combiner.rb:47
...
module SimpleCov::Combine::MethodsCombiner
  ...
  # @return [Hash]
  #
  # pkg:gem/simplecov#lib/simplecov/combine/methods_combiner.rb:21
  def combine(coverage_a, coverage_b); end
...
module SimpleCov::Combine::ResultsCombiner
  ...
  # @return [Hash]
  #
  # pkg:gem/simplecov#lib/simplecov/combine/results_combiner.rb:56
  ...
  # @return [Hash]
  #
  # pkg:gem/simplecov#lib/simplecov/combine/results_combiner.rb:37
...
module SimpleCov::Configuration
  ...
  #
  # pkg:gem/simplecov#lib/simplecov/configuration.rb:115
  ...
  #
  # pkg:gem/simplecov#lib/simplecov/configuration.rb:101
  ...
  #
  # pkg:gem/simplecov#lib/simplecov/configuration.rb:124
  ...
  #
  # pkg:gem/simplecov#lib/simplecov/configuration/formatting.rb:49
  ...
  #
  # pkg:gem/simplecov#lib/simplecov/configuration/formatting.rb:27
  ...
  #
  # pkg:gem/simplecov#lib/simplecov/configuration/formatting.rb:62
  ...
  #
  # pkg:gem/simplecov#lib/simplecov/configuration.rb:146
  ...
  #     end
  #
  # pkg:gem/simplecov#lib/simplecov/configuration/formatting.rb:84
  ...
  #
  # pkg:gem/simplecov#lib/simplecov/configuration/coverage.rb:59
  ...
  #
  # pkg:gem/simplecov#lib/simplecov/configuration/coverage.rb:73
  ...
  # pkg:gem/simplecov#lib/simplecov/configuration/coverage.rb:90
  ...
  # pkg:gem/simplecov#lib/simplecov/configuration/thresholds.rb:138
  ...
  #
  # pkg:gem/simplecov#lib/simplecov/configuration/thresholds.rb:145
  def per_file_coverage_replacement(defaults, overrides); end

  # Same, for a (deprecated) `minimum_coverage_by_group` argument.
  #
  # pkg:gem/simplecov#lib/simplecov/configuration/thresholds.rb:157
  ...
  # pkg:gem/simplecov#lib/simplecov/configuration/coverage_criteria.rb:140
  def raise_if_criterion_disabled(criterion); end

  # pkg:gem/simplecov#lib/simplecov/configuration/coverage_criteria.rb:149
  ...
  # pkg:gem/simplecov#lib/simplecov/configuration/thresholds.rb:168
  def render_coverage_blocks(by_criterion); end

  # Copy instance variables back to block_context and restore our saved values.
  #
  # pkg:gem/simplecov#lib/simplecov/configuration.rb:169
  def restore_ivars(block_context, saved); end

  # pkg:gem/simplecov#lib/simplecov/configuration/coverage.rb:103
  def store_minimum_per_file(criterion, percent, target); end

  # pkg:gem/simplecov#lib/simplecov/configuration/coverage.rb:114
  ...
  #
  # pkg:gem/simplecov#lib/simplecov/configuration/coverage.rb:98
  ...
  # later restoration.
  #
  # pkg:gem/simplecov#lib/simplecov/configuration.rb:158
  def swap_ivars_from(block_context); end

  # pkg:gem/simplecov#lib/simplecov/configuration/thresholds.rb:131
...
class SimpleCov::Configuration::CoverageCriterion
  # pkg:gem/simplecov#lib/simplecov/configuration/coverage.rb:126
  def initialize(config, criterion); end

  # Pin coverage to an exact figure (sets both `minimum` and `maximum`).
  #
  # pkg:gem/simplecov#lib/simplecov/configuration/coverage.rb:143
  ...
  #
  # pkg:gem/simplecov#lib/simplecov/configuration/coverage.rb:138
  def maximum(percent); end

  # Maximum allowed drop between runs (`maximum_drop 0` refuses any drop).
  #
  # pkg:gem/simplecov#lib/simplecov/configuration/coverage.rb:149
  def maximum_drop(percent); end

  # Overall (suite-wide) minimum for this criterion.
  #
  # pkg:gem/simplecov#lib/simplecov/configuration/coverage.rb:132
  ...
  #
  # pkg:gem/simplecov#lib/simplecov/configuration/coverage.rb:161
  def minimum_per_group(percent, only:); end

  # Make this criterion the report's primary (leading) criterion.
  #
  # pkg:gem/simplecov#lib/simplecov/configuration/coverage.rb:166
  def primary; end
end
...
class SimpleCov::CoverageStatistics
  ...
  #
  # pkg:gem/simplecov#lib/simplecov/coverage_statistics.rb:36
  ...
  # pkg:gem/simplecov#lib/simplecov/coverage_statistics.rb:47
  def compute_percent(covered, missed, total); end

  # pkg:gem/simplecov#lib/simplecov/coverage_statistics.rb:53
  def compute_strength(total_strength, total); end

  class << self
    # pkg:gem/simplecov#lib/simplecov/coverage_statistics.rb:17
...
module SimpleCov::CoverageViolations
  class << self
    ...
    #
    # pkg:gem/simplecov#lib/simplecov/coverage_violations.rb:55
    ...
    # pkg:gem/simplecov#lib/simplecov/coverage_violations.rb:133
    ...
    #
    # pkg:gem/simplecov#lib/simplecov/coverage_violations.rb:83
    def effective_per_file_thresholds(file, defaults, overrides); end

    # pkg:gem/simplecov#lib/simplecov/coverage_violations.rb:104
    def file_minimum_violation(file, criterion, expected); end

    # pkg:gem/simplecov#lib/simplecov/coverage_violations.rb:117
    def group_minimum_violations(group_name, group, minimums); end

    # pkg:gem/simplecov#lib/simplecov/coverage_violations.rb:124
    ...
    #
    # pkg:gem/simplecov#lib/simplecov/coverage_violations.rb:97
    ...
    #
    # pkg:gem/simplecov#lib/simplecov/coverage_violations.rb:74
    def percent_for(stats_source, criterion); end

    # pkg:gem/simplecov#lib/simplecov/coverage_violations.rb:143
...
class SimpleCov::Directive
  # pkg:gem/simplecov#lib/simplecov/directive.rb:132
  ...
  #
  # pkg:gem/simplecov#lib/simplecov/directive.rb:150
  ...
  # pkg:gem/simplecov#lib/simplecov/directive.rb:143
  def inline?; end
  ...
  class << self
    ...
    # pkg:gem/simplecov#lib/simplecov/directive.rb:120
    ...
    #
    # pkg:gem/simplecov#lib/simplecov/directive.rb:70
    ...
    #
    # pkg:gem/simplecov#lib/simplecov/directive.rb:113
    def inline?(lines, line_number, column); end

    # pkg:gem/simplecov#lib/simplecov/directive.rb:103
    def parse_categories(text); end

    # pkg:gem/simplecov#lib/simplecov/directive.rb:88
    ...
    # a directive.
    #
    # pkg:gem/simplecov#lib/simplecov/directive.rb:80
...
class SimpleCov::FileList
  ...
  # pkg:gem/simplecov#lib/simplecov/file_list.rb:148
...
class SimpleCov::Formatter::Base
  ...
  #
  # pkg:gem/simplecov#lib/simplecov/formatter/base.rb:67
  ...
  #
  # pkg:gem/simplecov#lib/simplecov/formatter/base.rb:77
  ...
  #
  # pkg:gem/simplecov#lib/simplecov/formatter/base.rb:87
...
class SimpleCov::Formatter::HTMLFormatter < ::SimpleCov::Formatter::Base
  ...
  #
  # pkg:gem/simplecov#lib/simplecov/formatter/html_formatter.rb:40
  ...
  #
  # pkg:gem/simplecov#lib/simplecov/formatter/html_formatter.rb:66
  def atomic_write(dest, content); end

  # pkg:gem/simplecov#lib/simplecov/formatter/html_formatter.rb:53
  def copy_static_assets(dest_dir = T.unsafe(nil)); end

  # pkg:gem/simplecov#lib/simplecov/formatter/html_formatter.rb:49
  def entry_point_filename; end

  # pkg:gem/simplecov#lib/simplecov/formatter/html_formatter.rb:74
  def public_dir; end
end
...
class SimpleCov::Formatter::JSONFormatter < ::SimpleCov::Formatter::Base
  ...
  # pkg:gem/simplecov#lib/simplecov/formatter/json_formatter.rb:41
  def entry_point_filename; end

  # pkg:gem/simplecov#lib/simplecov/formatter/json_formatter.rb:68
  def existing_meta(path); end

  # pkg:gem/simplecov#lib/simplecov/formatter/json_formatter.rb:37
  def message_prefix; end
  ...
  #
  # pkg:gem/simplecov#lib/simplecov/formatter/json_formatter.rb:49
...
class SimpleCov::Formatter::JSONFormatter::ErrorsFormatter
  ...
  # pkg:gem/simplecov#lib/simplecov/formatter/json_formatter/errors_formatter.rb:70
  def bucket(name); end

  # pkg:gem/simplecov#lib/simplecov/formatter/json_formatter/errors_formatter.rb:78
  ...
  # pkg:gem/simplecov#lib/simplecov/formatter/json_formatter/errors_formatter.rb:57
  ...
  # pkg:gem/simplecov#lib/simplecov/formatter/json_formatter/errors_formatter.rb:49
  ...
  # pkg:gem/simplecov#lib/simplecov/formatter/json_formatter/errors_formatter.rb:74
...
#
# pkg:gem/simplecov#lib/simplecov/result_adapter.rb:46
...
#
# pkg:gem/simplecov#lib/simplecov/result_adapter.rb:59
...
class SimpleCov::SourceFile::MethodBuilder
  ...
  #
  # pkg:gem/simplecov#lib/simplecov/source_file/method_builder.rb:33
  def eval_generated_to_ignore?(info); end

  # pkg:gem/simplecov#lib/simplecov/source_file/method_builder.rb:46
...
# simplecov:disable
#
# pkg:gem/simplecov#lib/simplecov/static_coverage_extractor/visitor.rb:15
...
#
# pkg:gem/simplecov#lib/simplecov/static_coverage_extractor/visitor.rb:28
class SimpleCov::StaticCoverageExtractor::Visitor < ::Prism::Visitor
  include ::SimpleCov::StaticCoverageExtractor::MethodCollector

  # pkg:gem/simplecov#lib/simplecov/static_coverage_extractor/visitor.rb:35
  def initialize; end

  # pkg:gem/simplecov#lib/simplecov/static_coverage_extractor/visitor.rb:33
  def branches; end

  # pkg:gem/simplecov#lib/simplecov/static_coverage_extractor/visitor.rb:33
  def methods; end

  # pkg:gem/simplecov#lib/simplecov/static_coverage_extractor/visitor.rb:59
  ...
  #
  # pkg:gem/simplecov#lib/simplecov/static_coverage_extractor/visitor.rb:67
  ...
  #
  # pkg:gem/simplecov#lib/simplecov/static_coverage_extractor/visitor.rb:49
  def visit_if_node(node); end

  # pkg:gem/simplecov#lib/simplecov/static_coverage_extractor/visitor.rb:54
  ...
  #
  # pkg:gem/simplecov#lib/simplecov/static_coverage_extractor/visitor.rb:152
  def arm_location(statements, fallback_location); end

  # simplecov:enable branch
  #
  # pkg:gem/simplecov#lib/simplecov/static_coverage_extractor/visitor.rb:164
  ...
  def else_body_of(else_node); end
  ...
  # pkg:gem/simplecov#lib/simplecov/static_coverage_extractor/visitor.rb:103
  ...
  # convention).
  #
  # pkg:gem/simplecov#lib/simplecov/static_coverage_extractor/visitor.rb:118
  def if_like_else_location(node); end
end
